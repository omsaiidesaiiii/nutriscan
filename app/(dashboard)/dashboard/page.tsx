    ...
    <div className="space-y-8 pb-8 animate-in">
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-zinc-500">
          You&apos;ve consumed {totals.calories} of {profile.target_calories}{" "}
          kcal today.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
        ...
        <div className="card overflow-hidden flex flex-col">
          ...
          <div className="p-4 border-t border-zinc-50">
            <Link
              href="/meals"
              className="w-full py-2.5 border border-zinc-200 rounded-xl flex items-center justify-center text-sm font-medium text-zinc-700 hover:bg-zinc-50 transition-all"
            >
              View all meals
            </Link>
          </div>
