        ...
        <div className="card overflow-hidden">
          ...
          {(!meals || meals.length === 0) ? (
            <div className="py-16 text-center px-6">
              ...
              <h3 className="text-sm font-semibold text-zinc-900">No meals logged yet</h3>
              <p className="text-xs text-zinc-400 mt-1">Use the form above to log your first meal.</p>
            </div>
          ) : (
