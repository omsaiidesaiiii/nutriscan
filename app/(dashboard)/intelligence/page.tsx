  ...
  const healthIndicators = [
    {
      ...
      active: profile.low_gi_priority,
      icon: Activity,
      color: "text-emerald-600",
      bg: "bg-emerald-50",
    },
    {
      label: "Hypertension-Safe",
      active: profile.sodium_warning,
      icon: ShieldCheck,
      color: "text-blue-600",
      bg: "bg-blue-50",
    },
    {
      label: "Heart Healthy",
      active: profile.heart_healthy_mode,
      icon: HeartPulse,
      color: "text-zinc-600",
      bg: "bg-zinc-50",
    },
    ...
    <div className="space-y-8 pb-8 animate-in">
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-zinc-500">
          Adaptive insights based on your biometric data and meal history.
        </p>
      </div>
