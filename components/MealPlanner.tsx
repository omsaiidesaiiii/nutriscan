...
export default function MealPlanner({
  ...
  const totalCalories = plan
    ? plan.breakfast.calories +
      ...
      plan.snack.calories
    : 0;
  const totalProtein = plan
    ? plan.breakfast.protein +
      plan.lunch.protein +
      plan.dinner.protein +
      plan.snack.protein
    : 0;
  const totalCarbs = plan
    ...
    : 0;
  const totalFat = plan
    ? plan.breakfast.fat + plan.lunch.fat + plan.dinner.fat + plan.snack.fat
    : 0;
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-xs text-zinc-400 mt-1 max-w-xs mx-auto">
              Generate an AI-powered meal plan tailored to your{" "}
              {profile.target_calories} kcal target.
            </p>
            <button
              onClick={generatePlan}
